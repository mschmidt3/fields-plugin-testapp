        ...
        <div id="create-book" class="content scaffold-create" role="main">
            ...
            <g:form resource="${this.book}" method="POST">
                <fieldset class="form">
                    ...
                    <f:field bean="book" property="pages" />
                    <f:field bean="book" property="releasedate" />
                    <f:field bean="book" property="description" widget="textarea" />
                    <f:field bean="book" property="available" />
